...
<body>
        ...
        if ($numrows == 0) {
            print "<h4>No Search Results Found</h4>";
                ...
                while($row = $result->fetch_assoc() ) {
                 ...
                 $prev = $incr10 - 10 ;
                 $incr10 += 10;
                 $pageGetStringBuildNext = "<a href = \"listorders?incr10=$incr10";
                 $pageGetStringBuildPrev = "<a href = \"listorders?incr10=$prev";
                 if (isset($confirmCode)) {
    ...
    <script>
        $(".clickable-row").click(function() {
            window.location = "order?ooid=" + $(this).data("href");
        });
    </script>
