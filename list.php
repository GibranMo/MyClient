            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                     ...
                     <li>
                        <a href="searchcustomer">Add Client</a>
                    </li>

                    <li>
                        <a href="addcustomer">Search Client</a>
                    </li>

                     <li>
                        <a href="addcustomer">Search Online Orders</a>
                    </li>
        ...
        <div class="cust-pagination">
           <?php if($page > 0 && $left_rec > $rec_limit) : ?>
                  <? 
                    $last = $page - 2;
                  ?>
                    <a href=<? print "list?page=$last"; ?> class="btn btn-primary btn-lg pagin">
                        <span class="glyphicon glyphicon-chevron-left"></span>Prev 10
                    </a>
                    <a href=<? print "list?page=$page"; ?>  class="btn btn-primary btn-lg pagin">
