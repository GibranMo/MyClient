...
<html lang="en">
    <head>
        ...
        <title>MyClient - Profile <?php echo $email?></title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="addcustomer">Add Client</a>
                        </li>

                        <li>
                            <a href="searchcustomer">Search Client</a>
                        </li>

                        <li>
                            <a href="searchorders">Search Online Orders</a>
                        </li>
        ...
        <div class="profx">
           ...
           <div class="row">
            ...
            ?>     
             ...
             <?php
                    print"<a href=\"addPackage?id=$custID&name=$preferredFirst&lastname=$preferredLast\" class=\"buttonx button6 fuc\">Add a Package</a> ";
